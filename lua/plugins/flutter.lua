    ...
    config = function()
      local register_keys = function()
        ...
        wk.add({
          ...
          { "<leader>mh", "<cmd>FlutterHotReload<cr>", desc = "Hot Reload" },
          { "<leader>mH", "<cmd>FlutterHotRestart<cr>", desc = "Hot Restart" },
          -- Testing
          { "<leader>mt", "<cmd>FlutterTest<cr>", desc = "Run Tests" },
          { "<leader>mT", "<cmd>FlutterTestCoverage<cr>", desc = "Test Coverage" },
          { "<leader>mta", "<cmd>FlutterTestAll<cr>", desc = "Run All Tests" },
          -- Building
          { "<leader>mb", "<cmd>FlutterBuildApk<cr>", desc = "Build APK" },
          { "<leader>mB", "<cmd>FlutterBuildIos<cr>", desc = "Build iOS" },
          { "<leader>mw", "<cmd>FlutterBuildWeb<cr>", desc = "Build Web" },
          { "<leader>mW", "<cmd>FlutterBuildWindows<cr>", desc = "Build Windows" },
          { "<leader>mL", "<cmd>FlutterBuildLinux<cr>", desc = "Build Linux" },
          { "<leader>mM", "<cmd>FlutterBuildMacos<cr>", desc = "Build macOS" },
          -- Debugging
          { "<leader>mD", "<cmd>FlutterDebug<cr>", desc = "Start Debugging" },
          { "<leader>mdd", "<cmd>FlutterDebugToggle<cr>", desc = "Toggle Debug Mode" },
          -- Utilities
          { "<leader>mC", "<cmd>FlutterClean<cr>", desc = "Flutter Clean" },
          { "<leader>mdo", "<cmd>FlutterDoctor<cr>", desc = "Flutter Doctor" },
          { "<leader>mup", "<cmd>FlutterUpgrade<cr>", desc = "Flutter Upgrade" },
          { "<leader>mch", "<cmd>FlutterChannel<cr>", desc = "Flutter Channel" },
        })
      end
